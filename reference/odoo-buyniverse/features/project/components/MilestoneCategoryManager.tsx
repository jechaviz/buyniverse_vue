...
interface MilestoneCategoryManagerProps {
    project: Job;
...
const MilestoneCategoryManager: React.FC<MilestoneCategoryManagerProps> = ({ project, onEdit, onDelete }) => {
    ...
    const columns: ColumnDef<DisplayMilestone>[] = useMemo(() => [
        {
            ...
            cell: ({ row }) => (
                <div className="flex items-center gap-3">
                    ...
                    {row.isDefault && <Tooltip content="Default category"><i className="fa-solid fa-star text-amber-400"></i></Tooltip>}
                </div>
            )
        },
...
export default MilestoneCategoryManager;