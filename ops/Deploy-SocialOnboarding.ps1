...
if ($SshAlias -notmatch '^[A-Za-z0-9._@-]+$' -or $RemoteDir -notmatch '^(?:~\/|\/)[A-Za-z0-9._/-]+$' -or $ReleaseRef -notmatch '^[A-Za-z0-9._/-]+$') {
...
$php = @'
<?php
$configPath = getenv("BUYNIVERSE_RUNTIME_CONFIG") ?: dirname(getcwd()) . "/buyniverse-runtime.php";
