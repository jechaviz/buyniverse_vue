<template><footer
  ...
  ><label class="flex items-center gap-2 text-slate-500"
      ...
      ><option :value="5">5</option><option :value="10">10</option><option :value="20">20</option><option :value="50">50</option></select></label
    ><div class="flex items-center justify-between gap-3 sm:justify-end"><span class="text-slate-500">{{ rangeLabel }}</span><div class="flex items-center gap-1"><button
        ...
        >
          »
        </button></div></div></footer></template>
<script>
export default {
props: {
