<template><Teleport to="body"><Transition name="toast"><div
        v-if="open"
      ...
      ><button
        ...
        ><div
          ...
          ><i class="fa-solid fa-magnifying-glass text-slate-400 text-sm"></i><input
              ref="searchInput"
              v-model.trim="query"
            ...
            /><kbd
              ...
              >ESC</kbd
            ></div><div class="max-h-[60vh] overflow-y-auto p-2.5 space-y-1"><button
            ...
            ><i class="fa-regular fa-face-frown-open text-3xl text-slate-300 dark:text-slate-600"></i><p class="mt-3 text-xs">No accessible result matches your search.</p></div></div><footer
          ...
          ><span class="flex items-center gap-2"><kbd class="rounded bg-white px-1.5 py-0.5 text-[10px] font-bold border border-slate-200 dark:bg-slate-800 dark:border-slate-700">↑↓</kbd> navigate
            ...
            </span><span class="text-[10px] font-medium">Role-based instant navigation</span></footer></section></div></Transition></Teleport></template>
<script>
