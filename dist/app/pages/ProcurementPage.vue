<template><section class="procurement-page space-y-5"><header
      class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between"
    ><div class="max-w-3xl"><p class="mb-1 text-[10px] font-800 uppercase tracking-wider text-brand">
          {{ contextLabel }}
        </p><div class="flex items-center gap-2"><h1
        ...
        >
          {{ current.description }}
        </p></div><div class="flex flex-wrap gap-2"><button v-if="canBuy" class="btn-muted" @click="exportWorkspace"><i class="fa-solid fa-download"></i>Export
        </button><RouterLink
    ...
    ><RouterLink
      ...
      ></nav><component :is="current.component" /></section></template>
<script>
